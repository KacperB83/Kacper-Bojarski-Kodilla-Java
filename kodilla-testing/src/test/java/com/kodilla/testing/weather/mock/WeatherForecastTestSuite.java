...
class WeatherForecastTestSuite {
    ...
    class TestGetWeatherForecast {
        ...
        void testCalculateAverageTemperatureWithMock() {
            ...
            WeatherForecast weatherForecast = new WeatherForecast(temperaturesMock);
            //When
            double averageTemp = weatherForecast.avgTemp();
            System.out.println(weatherForecast.avgTemp());
            //Then
        ...
        void testCalculateMedianTemperatureWithMock() {
            ...
            //When
            double medianTemp = weatherForecast.medianTemp();
            System.out.println(weatherForecast.medianTemp());
