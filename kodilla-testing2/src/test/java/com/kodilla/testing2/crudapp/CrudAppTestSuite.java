...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://kacperb83.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("k.bojarski.pl@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Kaprys00");
